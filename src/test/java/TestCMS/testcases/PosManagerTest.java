...
import TestCMS.pages.PosManagerPage;
...
public class PosManagerTest extends BaseTest {
    ...
    public void testAddNewPosManagerSuccess(Hashtable<String, String> data){
        ...
        //LIÊN KẾT TRANG: từ trang dashboardPage sang trang posManagerPage
        posManagerPage = dashboardPage.clickMenuPosManagerWithMenuPosSystem();
        posManagerPage.enterDataPosManeger(data);
    }
}
