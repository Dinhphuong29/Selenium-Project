...
public class DataProviderFactory {
    ...
    @DataProvider(name = "data_provider_posmanager_excel_hashtable", parallel = true)
    public Object[][] dataProviderPosManagerFromExcelWithHashtable(){
        //Khởi tạo đối tượng
        ExcelHelper excelHelper = new ExcelHelper();

        //Lấy ra dữ liệu chỉ định trong file Excel chỉ đinh
        Object[][] data = excelHelper.getDataHashTable(SystemHelper.getCurrentDir() + "src/test/resources/testdata/DataTest.xlsx", "PosManager", 1, 1);
        System.out.println("Add New posManager from Excel (Hashtable): " + data);

        //Trả về data Object[][] (object 2 chiều)
        return data;
    }
    @DataProvider(name = "data_provider_allorders_excel_hashtable", parallel = true)
    public Object[][] dataProviderAllOrdersFromExcelWithHashtable(){
        //Khởi tạo đối tượng
        ExcelHelper excelHelper = new ExcelHelper();

        //Lấy ra dữ liệu chỉ định trong file Excel chỉ đinh
        Object[][] data = excelHelper.getDataHashTable(SystemHelper.getCurrentDir() + "src/test/resources/testdata/DataTest.xlsx", "AllOrders", 1, 1);
        System.out.println("Add New allOrders from Excel (Hashtable): " + data);

        //Trả về data Object[][] (object 2 chiều)
        return data;
    }
//    @DataProvider(name = "data_provider_customerlist_excel_hashtable", parallel = true)
//    public Object[][] dataProviderCustomerListFromExcelWithHashtable(){
//        //Khởi tạo đối tượng
//        ExcelHelper excelHelper = new ExcelHelper();
//
//        //Lấy ra dữ liệu chỉ định trong file Excel chỉ đinh
//        Object[][] data = excelHelper.getDataHashTable(SystemHelper.getCurrentDir() + "src/test/resources/testdata/DataTest.xlsx", "PosManager", 1, 3);
//        System.out.println("Search Customer from Excel (Hashtable): " + data);
//
//        //Trả về data Object[][] (object 2 chiều)
//        return data;
//    }
